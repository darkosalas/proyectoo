...
# Streamlit app para evaluar calidad de agua con anuncio centrado
...
st.markdown(
    ...
    <div style='text-align: center; padding: 30px; border-radius: 20px;
                ...
                font-size: 36px; font-weight: bold; margin-top:20px; margin-bottom:20px;'>
        {decision}<br><span style='font-size:22px; font-weight:normal;'>{decision_text}</span>
    </div>
    """ ,
